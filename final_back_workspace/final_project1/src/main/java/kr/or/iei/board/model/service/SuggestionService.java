...
import kr.or.iei.board.model.dto.CommentDto; // CommentDto 임포트
...
public class SuggestionService {
     ...
     */
    @Transactional
    public int insertSuggestionComment(CommentDto comment, String isAdmin) {
        // 관리자 권한 체크 로직
        if (!"T".equals(isAdmin)) {
     ...
     */
    public ArrayList<CommentDto> selectSuggestionCommentList(int boardNo) {
     ...
     */
    @Transactional
    public int updateSuggestionComment(CommentDto comment, String isAdmin) {
        // 관리자 권한 체크 로직
        if (!"T".equals(isAdmin)) {
